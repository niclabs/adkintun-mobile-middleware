 ...
 * 
 * This class receives listeners to be notified upon a specific
 * event. Listeners are notified through a notifier class in order
 * to allow for different methods to be defined by listener. 
 * 
 * @author Felipe Lalanne <flalanne@niclabs.cl>
 *
 * @param <E> type of listener that this dispatcher takes
 */
